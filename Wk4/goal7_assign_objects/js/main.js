...
//Make the in the math.random formula sends to the constructor of person (new Person) and show the HTML row number it will be displayed  with the random chosen name from the names array
...
// Once the people array have all the Person Instances, create a loop to run this function for each person: function runUpdate(){people.forEach(funcation(element){element.update();});
