...
(function(){
	...
	var validate = function(query){//only need one "=" to assign variable //fixed this error
	...
	var search = function(query){ //search function begins here //forgot (){} //Fixed braces
		...
		for(var i=0, j=db.length; i<j; i++) {
			...
			var dbitem = db[i].toLowerCase().substring(0, dbTitleEnd); //fixed toLowerCase method

			// loop through the user's search query words
			// save a lowercase variable of the search keyword
			for (var ii = 0, jj = queryArray.length; ii < jj; ii++) {
				var qitem = queryArray[ii].toLowerCase(); //fixed toLowerCase method
	...
	var showMatches = function(results){ //this replaces document.write to create a div in a html doc
